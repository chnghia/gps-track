...
(function($) {
    ...
    var SlickEditor = {
        ...
        BoolCellFormatter : function(row, cell, value, columnDef, dataContext) {
            return value ? "<img src='/assets/images/slick/tick.png'>" : "";
        },
        ...
        TaskNameFormatter : function(row, cell, value, columnDef, dataContext) {
            ...
            return spacer + " <img src='/assets/images/slick/expand.gif'>&nbsp;" + value;
        },
        ...
        ResourcesFormatter : function(row, cell, value, columnDef, dataContext) {
            ...
            if (columnDef.width < 50)
                return (resources.length > 1 ? "<center><img src='/assets/images/slick/user_identity_plus.gif' " : "<center><img src='/assets/images/slick/user_identity.gif' ") +
        ...
        StarFormatter : function(row, cell, value, columnDef, dataContext) {
            return (value) ? "<img src='/assets/images/slick/bullet_star.png' align='absmiddle'>" : "";
        },
        ...
        DateCellEditor : function(args) {
            ...
            this.init = function() {
                ...
                $input.datepicker({
                    ...
                    buttonImage: "/assets/images/slick/calendar.gif",
        ...
        StarCellEditor : function(args) {
            ...
            this.init = function() {
                $input = $("<IMG src='/assets/images/slick/bullet_star.png' align=absmiddle tabIndex=0 title='Click or press Space to toggle' />")
